...
COPY nuclei1(geom) FROM 'wkt_n_nv10_nu5000_s10.dt' WITH DELIMITER AS '|';
...
COPY vessel(geom) FROM 'wkt_v_nv200_nu200_s10.wkt' WITH DELIMITER AS '|';
COPY nuclei1(geom) FROM 'wkt_n_nv200_nu200_s10.wkt' WITH DELIMITER AS '|';
COPY nuclei2(geom) FROM 'wkt_n2_nv200_nu200_s10.wkt' WITH DELIMITER AS '|';
