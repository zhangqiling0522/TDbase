...
__global__
void TriDist_cuda(const float *data, const uint32_t *offset_size, const float *hausdorff, result_container *dist, uint32_t tri_offset_1, uint32_t tri_offset_2_start){
	// which batch
