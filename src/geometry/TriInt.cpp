...
int coplanar_tri_tri3d(const float p1[3], const float q1[3], const float r1[3],
		const float p2[3], const float q2[3], const float r2[3],
		const float normal_1[3], const float normal_2[3]){
...
bool TriInt(const float *data1, const float *data2){
	const float *p1 = data1;
	const float *q1 = data1+3;
	const float *r1 = data1+6;
	const float *p2 = data2;
	const float *q2 = data2+3;
	const float *r2 = data2+6;
